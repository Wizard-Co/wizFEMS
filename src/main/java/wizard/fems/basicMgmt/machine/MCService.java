...
public class MCService {
     ...
     * @return
     */
    public MCDTO saveMachineDetail(String userID, MCDTO mcdto) {
        mcdto.setCreateUserID(userID);
     ...
     * @return
     */
    public MCDTO updateMachineDetail(String userID, MCDTO mcdto) {
        mcdto.setLastUpdateUserID(userID);
        mcdto.setInstallDate(date.DBDateFormat(mcdto.getInstallDate()));
