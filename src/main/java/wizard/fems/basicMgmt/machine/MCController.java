...
public class MCController {
    ...
    @PostMapping("/save")
    @ResponseBody
    public void save(@LoginUser User user, @ModelAttribute MCDTO mcdto) {

        mcService.saveMachineDetail(user.getUserID(), mcdto);
    }

    @PostMapping("/update")
    @ResponseBody
    public void update(@LoginUser User user, @ModelAttribute MCDTO mcdto) {

        mcService.updateMachineDetail(user.getUserID(), mcdto);
    }
